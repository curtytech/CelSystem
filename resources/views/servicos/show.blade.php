...
<div class="container  mt-4 ">
    ...
    <a class="btn btn-outline-dark my-2" href="{{ route('createServico') }}"> Novo Serviço </a>
</div>
<div class="container mt-3">
    ...
    <table class="table table-striped border border-dark rounded" id="dataTable">
        <thead class="bg-dark text-light">
            <tr>
                <th class="disableMobile text-center">Data:</th>
                <th class="text-center">Cliente:</th>
                <th class="disableMobile text-center">Celular:</th>
                <th class="disableMobile text-center">Categoria:</th>
                <th class="disableMobile text-center">Manutenção:</th>
        ...
        <tbody>
            ...
            @endforeach
            @if(count($servicos) == 0)
            <h4 class="text-center ">Não consta nenhum serviço na lista!</h4>
            <hr>
            @endif
